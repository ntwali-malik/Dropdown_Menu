  ...
  return (
    <div className="container mx-auto p-4">
      <header className="bg-gray-800 text-white py-5">
        <h1 className="text-4xl font-bold text-center">Service 1</h1>
        <p className="text-center mt-2">Detailed information about Service 1</p>
      </header>
      ...
      <main className="mt-10">
        <section className="mb-8">
          ...
          <p className="mt-4 text-gray-700">
            Service 1 is designed to provide you with exceptional benefits and features that cater to your specific needs. Our goal is to ensure you receive the highest quality service and support.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mt-4 text-gray-700">
            If you have any questions about Service 1 or would like more information, please don't hesitate to contact us.
          </p>
          <form className="mt-6">
            <div className="mb-4">
