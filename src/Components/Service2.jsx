  ...
  return (
    <div className="container mx-auto p-4">
      <header className="bg-gray-800 text-white py-5">
        <h1 className="text-4xl font-bold text-center">Service 2</h1>
        <p className="text-center mt-2">Detailed information about Service 2</p>
      </header>
      ...
      <main className="mt-10">
        <section className="mb-8">
          ...
          <p className="mt-4 text-gray-700">
            Service 2 offers comprehensive solutions tailored to meet your specific requirements. Our dedicated team ensures that you receive top-notch service and support.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mt-4 text-gray-700">
            If you have any questions about Service 2 or would like more information, please don't hesitate to contact us.
          </p>
          <form className="mt-6">
            <div className="mb-4">
